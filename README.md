...
Currently, auditing smart contracts at [Sayfer](https://sayfer.io/), [Oak Security](https://www.oaksecurity.io/), [Hashlock](https://hashlock.com/) and moreover actively participating in audit contests, as per the table below.
